...
<fieldset class="identity">
	...
	<div class="fields">
		...
		<div class="titration">
			<label>
				<span class="label">
					{translate key="user.titration"}
				</span>
				<input type="text" name="titration" id="titration" value="{$titration|escape}" required aria-required="true">
			</label>
		</div>
		<div class="country">
			<label>
		...
		<div class="state">
			<label>
				<span class="label">
					{translate key="user.state"}
					<span class="required" aria-hidden="true">*</span>
					<span class="pkp_screen_reader">
						{translate key="common.required"}
					</span>
				</span>
				<input type="text" name="state" id="state" value="{$state|escape}" required aria-required="true">
			</label>
		</div>
	</div>
</fieldset>
