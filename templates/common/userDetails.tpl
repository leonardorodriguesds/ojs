...
{fbvFormArea id="userDetails"}
	...
	{fbvElement type="text" label="common.state" name="state" id="state" required=false defaultLabel="" defaultValue="" value=$state translate="0" size=$fbvStyles.size.MEDIUM}
...
{capture assign="extraContent"}
	{fbvFormArea id="userFormExtendedLeft"}
		...
		{fbvFormSection for="titration"}
			{fbvElement type="text" label="user.titration" multilingual="true" name="titration" id="titration" value=$titration inline=true size=$fbvStyles.size.LARGE}
		{/fbvFormSection}
